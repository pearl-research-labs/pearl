...
use crate::v2::api::sanity_checks::public_params_sanity_check;
use crate::v2::circuit::chip::blake3::program::{AuxiliaryCvLocation, AuxiliaryMsgLocation, BlakeProgram};
use crate::v2::circuit::pearl_circuit::PearlCircuitParams;
...
mod tests {
    ...
    fn test_zk_proof_public_data_moe_roundtrip() {
        use crate::v2::api::proof::MoEParams;
