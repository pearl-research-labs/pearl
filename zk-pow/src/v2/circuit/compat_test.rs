...
mod test {
    ...
    use crate::v2::circuit::utils::evaluator::Evaluator;
    ...
    fn starky_hash(block_header: IncompleteBlockHeader, plain_proof: &PlainProof) -> String {
        ...
        let (private_params, public_params) =
            crate::v2::api::plain_proof::parse_plain_proof(block_header, plain_proof, SeedDerivation::Legacy)
    ...
    fn moe_params() -> (IncompleteBlockHeader, MiningConfiguration, usize, usize, usize) {
        use crate::v2::api::proof::MoEConfig;
        let rank = 32u16;
        let k = 1024usize;
    ...
    fn generate_and_write_moe_proof(proof_path: &Path) {
        use crate::v2::mine::try_mine_one_moe;
