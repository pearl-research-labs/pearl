...
use crate::v2::api::proof::PrivateProofParams;
use crate::v2::circuit::chip::AuxData;
use crate::v2::circuit::chip::blake3::program::{DWORD_SIZE, MatDwordId};
#[cfg(debug_assertions)]
use crate::v2::circuit::chip::compute_jackpot;
use crate::v2::circuit::pearl_layout::{BYTES_PER_GOLDILOCKS, pearl_columns, pearl_public};
use crate::v2::circuit::pearl_noise::MMSlice;
use crate::v2::circuit::pearl_preprocess::{generate_preprocessed, read_dword_from_matrix};
use crate::v2::circuit::pearl_program::{TILE_D, TILE_H};
use crate::v2::circuit::pearl_stark::{PearlStarkChips, PearlStarkConfig};
use crate::v2::circuit::utils::trace_utils::{RowBuilder, read_from_trace, u64_pack_le};
...
pub fn generate_trace<F: RichField + Extendable<D>, const D: usize>(
    ...
    public_params: &crate::v2::api::proof::PublicProofParams,
    ...
    #[cfg(debug_assertions)]
    {
        use crate::v2::circuit::utils::trace_utils::bytes_to_words;
