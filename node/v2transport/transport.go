...
// HandshakeAdmission gates the CPU-bound phases of an inbound v2 handshake so a flood of accepted sockets cannot
// pin ECDH.
...
func WithResponderHandshakeAdmission(admission HandshakeAdmission) PeerOption {
	return func(p *Peer) {
