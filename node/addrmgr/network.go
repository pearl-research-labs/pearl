...
var (
	...
	// rfc7343Net specifies the IPv6 ORCHIDv2 address block as defined by RFC7343 (2001:20::/28).
	...
	// zero6Net defines the IPv6 address block for addresses with a zero first 16-bit group (0000::/16). /16
	// rather than the full /8 reservation avoids catching allocated sub-ranges like 0064:ff9b::/96.
...
// IsZero returns whether the address is in a reserved zero address block. RFC 6145 translated IPv4 addresses
// (::ffff:0:0:0/96) are excluded.
...
// IsRFC7343 returns whether the address is in the IPv6 ORCHIDv2 range defined by RFC7343 (2001:20::/28).
