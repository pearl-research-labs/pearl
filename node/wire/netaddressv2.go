...
// ipv4MappedPrefix is the prefix for IPv4-mapped IPv6 addresses (::ffff:0:0/96) as defined by RFC 4291.
...
func NetAddressV2FromBytes(timestamp time.Time, services ServiceFlag,
	...
	case ipv6Size:
		...
		// IPv4-mapped IPv6 addresses (::ffff:0:0/96) should use the IPv4 networkID. Go's net.IP commonly stores
		// IPv4 addresses in this 16-byte form, so extract the 4-byte IPv4 address.
