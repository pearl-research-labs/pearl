// Baseline twin of pearl_gemm_sm89_denoise_inst.cu — uses SimpleTileScheduler.
// Exposes `pearl_gemm_sm89_denoise_128x128x64_R64_baseline`.
...
using DenoiseTraits128x128x64_R64_BL = KernelTraitsSm89<
...
template void pearl_gemm_sm89_run_baseline<DenoiseTraits128x128x64_R64_BL>(
    typename pearl::CollectiveMainloopSm89<
        DenoiseTraits128x128x64_R64_BL>::Arguments const&,
...
extern "C" void pearl_gemm_sm89_denoise_128x128x64_R64_baseline(
    ...
    int M, int N, int K,
    cudaStream_t stream) {
  using KTraits = DenoiseTraits128x128x64_R64_BL;
